...
- Overview (filter + parsed grading + OCR snippet): [Overview](docs/assets/01_overview.png)
- Expand row to view OCR full text: [OCR Full Text](docs/assets/02_expand_ocr_fulltext.png)
- Filter example (Final exam, threshold >= 15%): [Final >=15%](docs/assets/03_filter_final_15.png)
...
- `web.html`  
  Simple UI (reads `data/course_grading.csv` + `data/override.csv`)
